...
class SearchedArtifact(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, created_on, created_by, type, state, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, created_on, created_by, type, state, *args, **kwargs):  # noqa: E501
        """SearchedArtifact - a model defined in OpenAPI
