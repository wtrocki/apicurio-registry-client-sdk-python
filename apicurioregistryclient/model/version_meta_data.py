...
class VersionMetaData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, version, created_by, created_on, type, global_id, id, content_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            state (ArtifactState): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, version, created_by, created_on, type, global_id, id, content_id, *args, **kwargs):  # noqa: E501
        """VersionMetaData - a model defined in OpenAPI
