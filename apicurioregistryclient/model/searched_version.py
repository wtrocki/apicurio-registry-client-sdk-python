...
class SearchedVersion(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_on, created_by, type, state, global_id, version, content_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_on, created_by, type, state, global_id, version, content_id, *args, **kwargs):  # noqa: E501
        """SearchedVersion - a model defined in OpenAPI
