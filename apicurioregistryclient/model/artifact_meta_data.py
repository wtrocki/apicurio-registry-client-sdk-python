"""
    ...
    The version of the OpenAPI document: 2.2.1.Final
...
class ArtifactMetaData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_by, created_on, modified_by, modified_on, id, version, type, global_id, state, content_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_by, created_on, modified_by, modified_on, id, version, type, global_id, state, content_id, *args, **kwargs):  # noqa: E501
        """ArtifactMetaData - a model defined in OpenAPI
